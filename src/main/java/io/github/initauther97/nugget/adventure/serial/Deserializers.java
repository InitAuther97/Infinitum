...
import io.github.initauther97.nugget.adventure.nbt.api.BinaryTagHolder;
...
public class Deserializers {
    ...
    public static final Deserializer<String, TextDecoration> TEXT_DECORATION = Deserializer.complexFunction(PlainTextEntry::plain, TextDecoration::new);
